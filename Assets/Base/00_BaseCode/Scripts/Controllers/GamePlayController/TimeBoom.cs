...
public class TimeBoom : BarrierBase
{
    ...
    public void HandleExplosion()
    {
        if(!wasTakeDame)
        {
            ...
            if(!GamePlayController.Instance.playerContain.timeBoom_Item.TimeBoom_First)
            {
                GamePlayController.Instance.playerContain.timeBoom_Item.OffTut();
                GamePlayController.Instance.playerContain.timeBoom_Item.TimeBoom_First = true;
            }    
